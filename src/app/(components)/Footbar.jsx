...
function Footbar() {
    ...
    return (
       ...
       {showTypewriter && (
        <div
          className={`fixed bottom-5 w-full flex justify-center z-50 transition-all duration-500 transform ${
            showTypewriter ? 'opacity-100 translate-x-4' : 'opacity-0 translate-y-0'
          }`}
        >
